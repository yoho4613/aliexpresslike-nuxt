<template>
  <div id="AuthPage" class="w-full h-[100vh] bg-white">
    <div class="w-full flex items-center justify-center p-5 vorder-b border-b-gray-300">
    ...
    <div class="max-w-[400px] mx-auto px-2">
      ...
      <button @click="login('google')"
        ...
        <img class="w-full max-w-[30px]" src="/google-logo.png" alt="google login">
        <div>Google</div>
      </button>
      <button @click="login('github')"
        ...
        <img class="w-full max-w-[30px]" src="/github-logo.png" alt="google login">
        <div>Github</div>
      </button>
    </div>
  </div>
