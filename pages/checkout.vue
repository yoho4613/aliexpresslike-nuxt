      ...
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        <div class="md:w-[65%]">
          <div class="bg-white rounded-lg p-4">
            ...
            <div v-if="currentAddress && currentAddress.data">
              <NuxtLink to="/address" class="flex items-center pb-2 text-blue-500 hover:text-red-500">
        ...
        <div class="md:w-[35%]">
          ...
          <div class="bg-white rounded-lg p-4 mt-4">
            <div class="text-lg font-semibold mb-2 mt-2">AllExpress</div>
            <p class="my-2">AllExpress keeps your information and payment safe</p>
          </div>
        </div>
